...
const KefCares = () => {
  ...
  const [form, setForm] = useState({
    full_name: "", gender: "", date_of_birth: "", phone_number: "", whatsapp_active: false,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!form.full_name || !form.gender || !form.phone_number || !form.lga) {
      ...
      <div className="pt-24 pb-16">
        ...
        <section className="bg-gradient-to-br from-emerald-900 via-emerald-800 to-emerald-950 text-white py-16">
          <div className="container mx-auto px-4 text-center max-w-4xl">
            <h1 className="text-3xl md:text-5xl font-black mb-4">KEF-CARES</h1>
        ...
        <section className="container mx-auto px-4 py-12 max-w-4xl">
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            ...
            <div className="bg-emerald-50 dark:bg-emerald-950/30 rounded-xl p-6 border border-emerald-200 dark:border-emerald-800">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Registration helps create a verified community database that identifies skills, occupations, and economic needs across the Central Zone. This allows KEF-CARES to develop practical support programmes in entrepreneurship, agriculture, trading support, professional networking, vocational development, and youth empowerment.
              </p>
            </div>
          </div>

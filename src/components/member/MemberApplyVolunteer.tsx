      ...
      <div className="space-y-6">
        ...
        <Card className="p-8 text-center max-w-2xl">
          ...
          <p className="text-sm text-muted-foreground">
            Submitted on {new Date(existing.created_at).toLocaleDateString()}. Our coordination team will reach out with
            next steps.
          </p>
  ...
  return (
    <div className="space-y-6 max-w-3xl">
      ...
      <Card className="p-6 space-y-4">
        ...
        <p className="text-sm text-muted-foreground">
          I declare that the information provided is true and accurate. I understand that my role as a volunteer is
          crucial in promoting the Plateau Consensus Movement and supporting our endorsed candidates.
        </p>
        <div className="grid md:grid-cols-2 gap-4">
          <div>

...
const menuItems = [
  ...
  { id: "apply-agent", label: "Polling Unit Agent", icon: Award },
  { id: "apply-aspirant", label: "Elective Office", icon: ShieldCheck },
  { id: "apply-volunteer", label: "Volunteer", icon: HeartHandshake },

...
const HeroSection = () => {
  ...
  const paragraph2 = content?.paragraph2 || "We believe that when young people are economically empowered, families are stabilized, mothers are strengthened, and communities move forward. The movement spans the entire Plateau State, building a verified digital community and scalable infrastructure across all zones.";
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-12 items-center">
          ...
          <div className="space-y-5 md:space-y-7 text-center lg:text-left">
            ...
            >
              ...
              <span className="flex items-center gap-1.5">
                <span className="w-1.5 h-1.5 rounded-full bg-primary" /> All of Plateau State
              </span>
            </motion.div>
          </div>

...
const navLinks: { label: string; href: string; external?: boolean; disabled?: boolean }[] = [
  ...
  { label: "Support Group", href: "/support-group" },
            ...
            {user ? (
              <>
                ...
                {isKefUser && !isAdmin && !isSuperAdmin && !isAgent && (
                  <Button size="sm" variant="default" onClick={() => navigate("/kef-cares/dashboard")}>
                    KEF Dashboard
                  </Button>
                )}
                {!isKefUser && (
              ...
              <>
                <Button size="sm" variant="default" onClick={() => navigate("/join")}>
                  Join Us
                </Button>

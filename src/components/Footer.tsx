    ...
    <footer className="bg-primary text-primary-foreground border-t border-primary/80">
      <div className="container mx-auto px-4 lg:px-8 py-16">
        ...
        >
          ...
          {/* Movement */}
          <div>
            <h4 className="font-bold text-sm uppercase tracking-widest mb-4">Movement</h4>
            <ul className="space-y-2">
              <li><Link to="/about" className="text-sm text-muted-foreground hover:text-primary transition-colors">Our Vision</Link></li>
              <li><Link to="/about" className="text-sm text-muted-foreground hover:text-primary transition-colors">About us</Link></li>
              <li><Link to="/situation-room" className="text-sm text-muted-foreground hover:text-primary transition-colors">Situation Room</Link></li>
              <li><Link to="/discuss" className="text-sm text-muted-foreground hover:text-primary transition-colors">Discuss</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              <Input placeholder="Enter Your Email here" className="bg-secondary border-border" />
